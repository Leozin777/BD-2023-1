...
SELECT Livros.titulo as titulo, Autores.nome as nome_autor, Livros.valor_unit as preco, SUM(vendas_livros.qtd_livro_vendido) as qtd_livro_vendido
FROM Livros
    JOIN Autores_livros
...
GROUP BY Livros.id
ORDER BY qtd_livro_vendido DESC
...
SELECT Clientes.nome as nome_cliente, SUM(Vendas.qtd_livro_vendido) as qtd_compras
FROM Clientes
    JOIN Vendas
