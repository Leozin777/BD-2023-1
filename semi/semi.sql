...
SELECT Livros.titulo as titulo, Autores.nome as nome_autor, Livros.valor_unit as preco, SUM(vendas_livros.id_livro) as qtd_livro_vendido
FROM Livros
    JOIN Autores_livros
...
SELECT Clientes.nome as nome_cliente, SUM(Vendas.id_cliente) as qtd_compras
FROM Clientes
    JOIN Vendas
